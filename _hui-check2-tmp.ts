...
for P in '80c4aa5b-607f-4143-9dd1-aa8b12ec4195' 'vern.80c4aa5b-607f-4143-9dd1-aa8b12ec4195' 'wLrggS.vxJ2Jq'; do
  echo "--- $P ---"
  curl -sS -X POST http://127.0.0.1:8081/hui/hysteria2/auth -A 'Hysteria/2.6.0' -H 'Content-Type: application/json' -d "{\\"auth\\":\\"$P\\",\\"addr\\":\\"1.2.3.4:1234\\",\\"tx\\":0}" -w '\\n'
  sleep 1
done
`))
