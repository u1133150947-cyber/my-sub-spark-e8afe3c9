...
echo '--- direct https auth ---'
curl -ksS --http1.1 -A 'Mozilla/5.0' -i -X POST https://127.0.0.1:8081/hui/hysteria2/auth -H 'Content-Type: application/json' -d '{"auth":"80c4aa5b-607f-4143-9dd1-aa8b12ec4195","addr":"1.2.3.4:1234","tx":0}'
echo
echo '--- log tail ---'
