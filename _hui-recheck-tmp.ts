...
echo '--- vern row ---'
sqlite3 $DB "SELECT id,username,con_pass,expire_time,quota,download,upload,kick_util_time,deleted FROM account WHERE username='vern';"
sleep 5
echo '--- auth attempt ---'
curl -ksS --http1.1 -A 'Mozilla/5.0' -X POST https://127.0.0.1:8081/hui/hysteria2/auth -H 'Content-Type: application/json' -d '{"auth":"80c4aa5b-607f-4143-9dd1-aa8b12ec4195","addr":"1.2.3.4:1234","tx":0}'; echo
`));
